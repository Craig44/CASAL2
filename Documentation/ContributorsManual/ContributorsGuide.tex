...
\usepackage[font=bf,format=hang,labelsep=colon,justification=centering,singlelinecheck=false,compatibility=false]{caption}
...
\usepackage{comment} % block commentsEstimation_section
\usepackage{csquotes} % for closing quotes \enquote{text}
\usepackage{listings}
\usepackage{xcolor}
\lstset { %
	language=C++,
